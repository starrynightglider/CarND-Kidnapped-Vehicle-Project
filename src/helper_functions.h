...
inline double distSquare(const LandmarkObs &obs1, const LandmarkObs &obs2){
	return (obs2.x - obs1.x) * (obs2.x - obs1.x) +
	            (obs2.y - obs1.y) * (obs2.y - obs1.y);
}
